                    ...
                    <form action="#calculator" method="post">
                        <div class="col-xl-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="amount" required value="<?= $_POST['amount'] ?>" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="apy" required value="<?= $_POST['apy'] ?>" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="period" required value="<?= $_POST['period'] ?>" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </div>
                    ...
                    <form action="#password" method="POST">
                        <div class="col-xl-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="password" required value="<?= $_POST['password'] ?>" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </div>
